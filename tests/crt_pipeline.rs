...
#[test]
fn crt_pipeline_rejects_three_mixed_help_tokens_after_double_dash_without_summary_suffix() {
  let args = vec![
    "--".to_string(),
    "-h".to_string(),
    "--help".to_string(),
  ...
  assert_pipeline_failure_contains(&output, "unexpected positional arguments: -h, --help, --cc");
}
