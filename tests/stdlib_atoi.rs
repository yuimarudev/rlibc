...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_double_minus_digit_no_conversion() {
  let input = b"--7\0";
  let input_ptr = as_c_char_ptr(input);
...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_plus_minus_digit_no_conversion() {
  let input = b"+-7\0";
  let input_ptr = as_c_char_ptr(input);
...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_minus_plus_digit_no_conversion() {
  let input = b"-+7\0";
  let input_ptr = as_c_char_ptr(input);
...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_sign_newline_digit_no_conversion() {
  let input = b"+\n7\0";
  let input_ptr = as_c_char_ptr(input);
...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_minus_tab_digit_no_conversion() {
  let input = b"-\t7\0";
  let input_ptr = as_c_char_ptr(input);
...
#[test]
fn atoi_family_keeps_einval_after_null_input_then_sign_tab_digit_no_conversion() {
  let input = b"+\t7\0";
  let input_ptr = as_c_char_ptr(input);
