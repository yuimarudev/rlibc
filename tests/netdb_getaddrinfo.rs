...
#[test]
fn getaddrinfo_resolves_mixed_case_www_https_service_name_without_ai_numericserv() {
  let host = CString::new("127.0.0.1").expect("host literal must be NUL-free");
  let service = CString::new("WwW-HtTpS").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_resolves_mixed_case_www_http_service_name_without_ai_numericserv() {
  let host = CString::new("127.0.0.1").expect("host literal must be NUL-free");
  let service = CString::new("WwW-HtTp").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_resolves_mixed_case_domain_service_name_without_ai_numericserv_for_udp() {
  let host = CString::new("127.0.0.1").expect("host literal must be NUL-free");
  let service = CString::new("DoMaIn").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_resolves_mixed_case_domain_service_name_without_ai_numericserv_for_tcp() {
  let host = CString::new("127.0.0.1").expect("host literal must be NUL-free");
  let service = CString::new("DoMaIn").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_resolves_domain_service_name_without_ai_numericserv_with_null_node() {
  let service = CString::new("domain").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
  ...
  unsafe {
    let first = &*result;
    let first_addr = &*sockaddr_ptr_as_in(first.ai_addr);
...
#[test]
fn getaddrinfo_resolves_mixed_case_domain_service_name_without_ai_numericserv_with_null_node() {
  let service = CString::new("DoMaIn").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_rejects_unknown_service_name_without_ai_numericserv_with_null_node_and_eai_service()
{
  let service = CString::new("definitely-not-a-service").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
...
#[test]
fn getaddrinfo_rejects_unknown_service_name_with_ai_numericserv_with_null_node_and_eai_noname() {
  let service = CString::new("definitely-not-a-service").expect("service literal must be NUL-free");
  let mut hints = empty_hints();
  let mut result = ptr::null_mut();
